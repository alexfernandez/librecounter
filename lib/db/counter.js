...
export function storeCounter(counter) {
	...
	incrementFields('sites', {site: counter.site, day: counter.day}, updateWithPage)
	incrementFields('pages', {site: counter.site, day: counter.day, page: counter.page}, update)
}
