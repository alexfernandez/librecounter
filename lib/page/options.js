...
export function createOptions() {
	...
	<header>
		<div class="logo">
		<!-- the logo here does not increase the counter since it's used with /img, the old style below does -->
	...
	<article>
		<h2>Default</h2>
		<p>
		The default style is to show a logo
...
<img src="https://librecounter.org/counter.svg" referrerPolicy="unsafe-url" />
		...
		<p>
		The "unsafe-url" referrer policy is there to make sure that the browser
		sends the whole referrer to LibreCounter,
		so it can do its thing and attribute the page correctly.
		</p>
...
<img src="https://librecounter.org/unique.svg" referrerPolicy="unsafe-url" />
		...
		<p>
		If you prefer the LibreCounter isotype to be hidden the HTML snippet to add is even simpler:
		</p>
